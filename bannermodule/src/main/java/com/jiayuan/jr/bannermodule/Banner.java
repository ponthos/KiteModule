...
import com.jiayuan.jr.bannermodule.listener.OnBannerClickListener;
import com.jiayuan.jr.bannermodule.listener.OnBannerListener;
import com.jiayuan.jr.bannermodule.loader.ImageLoaderInterface;
import com.jiayuan.jr.bannermodule.view.BannerViewPager;
...
public class Banner extends ConstraintLayout implements OnPageChangeListener {
    ...
    private int mLayoutResId = R.layout.bannermodule_banner;
    ...
    private void setBannerStyleUI() {
        int visibility =count > 1 ? VISIBLE : GONE;
        switch (bannerStyle) {
